                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {randomBiodatas.map((biodata, index) => (
                        ...
                        >
                            ...
                            />
                            <h3 className="text-xl font-semibold">{biodata.name || "Unknown"}</h3>
                            <p className="text-gray-600">Age: {biodata.age || "N/A"}</p>
                            <p className="text-gray-500">Location: {biodata.permanentDivision || "N/A"}</p>
                            <Link to={`/biodata-details/${biodata.biodataId}`}>
                                <button className="mt-4 px-4 py-2 bg-BgPrimary text-white rounded-lg hover:bg-BgPrimary">
                                    View Profile
                                </button>
                            </Link>
                        </div>
