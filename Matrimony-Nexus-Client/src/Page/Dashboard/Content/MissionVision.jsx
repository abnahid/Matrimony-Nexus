    ...
    return (
        <section className="bg-white py-28 px-6 md:px-20">
            <div className="max-w-5xl mx-auto">
                ...
                {/* Mission Section */}
                <div className="mb-12">
                    <h3 className="text-2xl font-semibold text-purple-700 mb-4">🌟 Mission Statement</h3>
                ...
                {/* Vision Section */}
                <div>
                    <h3 className="text-2xl font-semibold text-green-700 mb-4">🌈 Vision Statement</h3>
                    <p className="text-gray-700 text-lg leading-relaxed">
